...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_renderHomePage_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/renderHomePage.js */ \"./src/modules/renderHomePage.js\");\n/* harmony import */ var _modules_getMovies_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/getMovies.js */ \"./src/modules/getMovies.js\");\n/* harmony import */ var _modules_renderPopup_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/renderPopup.js */ \"./src/modules/renderPopup.js\");\n/* harmony import */ var _modules_getLikeData_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/getLikeData.js */ \"./src/modules/getLikeData.js\");\n/* harmony import */ var _modules_postLikeData_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/postLikeData.js */ \"./src/modules/postLikeData.js\");\n/* harmony import */ var _modules_homePageCounter_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/homePageCounter.js */ \"./src/modules/homePageCounter.js\");\n\n\n\n\n\n\n\n\n\nconst showContainer = document.querySelector('.movie-section');\nconst popupContainer = document.querySelector('.popup-display');\nconst showCount = document.querySelector('.show-count');\n\nconst addEvents = () => {\n  const heartIcon = document.querySelectorAll('.fa-heart');\n  heartIcon.forEach((element) => {\n    element.addEventListener('click', () => {\n      (0,_modules_postLikeData_js__WEBPACK_IMPORTED_MODULE_5__[\"default\"])(element.dataset.id);\n    });\n  });\n};\n\nwindow.addEventListener('load', async () => {\n  const shows = await (0,_modules_getMovies_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])();\n  (0,_modules_renderHomePage_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(shows);\n  addEvents();\n  (0,_modules_getLikeData_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"])();\n  document.addEventListener('click', async (e) => {\n    const button = e.target.closest('.comments-btn');\n    const closeButton = e.target.closest('.close-icon');\n\n    if (button) {\n      const selectedShow = shows.filter(\n        (it) => it.id.toString() === button.id.toString(),\n      )[0];\n      const {\n        id, image, name, language, genres, rating, schedule,\n      } = selectedShow;\n      showContainer.style.display = 'none';\n      popupContainer.style.display = 'block';\n      (0,_modules_renderPopup_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(id, image, name, language, genres, rating, schedule);\n    }\n\n    if (closeButton) {\n      popupContainer.style.display = 'none';\n      showContainer.style.display = 'grid';\n      (0,_modules_renderHomePage_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(shows);\n      addEvents();\n      (0,_modules_getLikeData_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"])();\n    }\n  });\n\n  const showContent = document.querySelectorAll('.single-movie');\n  showCount.innerHTML = (0,_modules_homePageCounter_js__WEBPACK_IMPORTED_MODULE_6__[\"default\"])(showContent);\n});\n\n\n//# sourceURL=webpack://javascriptcapstone/./src/index.js?");
